...
import com.resto.rkmalik.data.FoodItem;
import com.resto.rkmalik.data.Order;
import com.resto.rkmalik.data.Restaurant;
...
public class RestaurantModel {
    ...
    public static List<FoodItem> getFavourites(SQLiteDatabase db, int restId) {
        Cursor cursor = db.rawQuery("select fooditem.* from fooditem,menu where menu.rest_id="+restId+" and fooditem.catId=menu.category_id and fooditem.is_fav=1", null);
        return getFoodItemsFromCursor(cursor);
    }
